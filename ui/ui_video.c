...
void Menu_Video_Init (void)
{
	...
	//BC changes here must be propogated to vid_dll.c

	static const char *resolutions[] = 
	{
		"[640x480  ]",  //0
		"[800x600  ]",  //1
		"[856x480  ]", //2 Knightmare added  
		"[960x720  ]",  //3
		"[1024x768 ]", //4
		"[1152x864 ]", //5
		"[1280x720 ]", //6
		"[1280x800 ]", //7 Knightmare added
		"[1280x960 ]", //8
		"[1280x1024]", //9 Knightmare added
		"[1360x768 ]", //10
		"[1366x768 ]", //11
		"[1400x1050]", //12 Knightmare added		
		"[1440x900]",  //13
		"[1600x900]", //14
		"[1680x1050]", //15 Knightmare added
		"[1920x1080]", //16
		"[1920x1200]", //17 Knightmare added
		"[1920x1440]", //18 Knightmare added
		"[2048x1536]", //19
		"[2560x1080]", //20
		"[2560x1440]", //21
		"[3440x1440]", //22
